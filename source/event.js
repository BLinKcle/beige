...
.addField("Q: In Limited Edition(LE) event, is it possible to not get the possible pictures shown? ","The probability of getting the actual picture card is very low. It is possible to not get the pictures of reward shown or to not get an artist card at all. ",true)
