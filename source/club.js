...
.setTitle("Club FAQ")
  ...
  .addField("Q: Is there a card for the top 3 club during group birthdays/anniversary?",
    "A: As of the moment, there is no card for group birthdays.", true)
...
.addField("Q: After the 3000 M-coin donation, what are the succeeding diamond donations and contribution points equivalent?","The next diamond donation is 25 dias for 125 contribution points. The succeeding donation points will increase by 25 dias and 125 contribution points until the 9 times donation limit is reached.",true)
