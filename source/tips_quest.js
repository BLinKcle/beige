...
.addField("by BLinKcle:","For evolve n artist task, the fastest and cheapest way is to evolve a level 1 rank 1 to level 10 rank 2 (2k Mcoins for evolve + around 5k mcoins (even less if you use 2 star exp)) then feed it to another level 1 rank 1 to upgrade to level 10 (700 mcoins) then evolve the upgraded card (2k mcoins) then repeat the process n times.",true)
