...
.addField("Q: How do I promote a traine to Artist?","To promote a card, you need 2 cards that have the same rank as your card which means you only need a level 1 rank 5 trainee card.",true)
.addField("Q: Will the influence differ depending on the card I use to upgrade?","Yes, but it will only be true until rank 5 level 50. Afterwhich, all cards will have the same influence of the same level.",true)
